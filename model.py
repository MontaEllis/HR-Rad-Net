...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.radiomics_feature = nn.Linear(361, 2048)
    ...
    # def forward(self, x):
        ...
        y_ = F.relu(self.radiomics_feature(radiomics), inplace=True)
        y = self.classifier(y+y_)
    ...
    def init_weights(self, pretrained='',):
        ...
        if os.path.isfile(pretrained):
            ...
            pretrained_dict = {k: v for k, v in pretrained_dict.items()
                               if (k in model_dict.keys() and k != 'classifier.weight' and k != 'classifier.bias')}
...
def get_cls_net(config, **kwargs):
    ...
    model.init_weights('/data/zkn/others/med/GCNn/classifier/pretrained/hrnetv2_w18_imagenet_pretrained.pth')
    return model
